export const tourMock = {
    ...
    libri3: {
        ...
        tourCover: {
            titleTest: 'libri',
            tourCard:
                'This will take you to a page where you’ll be asked to authenticate with your Google account. Select the account that you’d like this project to be affiliated with',
        },
        pointOfInterest: [
            {
                lat: 52.522114,
